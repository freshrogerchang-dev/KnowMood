...
export const EMOTION_REACTIONS = {
  happy: [
    { icon: 'clap', text: '拍拍手' },
    { icon: 'jump', text: '跳來跳去' },
    { icon: 'speaker', text: '笑出聲音' },
    { icon: 'rewards', text: '想跟大家分享' },
  ],
  sad: [
    { icon: 'tear', text: '眼淚掉下來' },
    { icon: 'toy', text: '想找人抱抱' },
    { icon: 'droop', text: '頭低低的' },
    { icon: 'stop', text: '什麼都不想做' },
  ],
  angry: [
    { icon: 'fist', text: '握緊拳頭' },
    { icon: 'megaphone', text: '大聲說話' },
    { icon: 'stomp', text: '腳用力踩' },
    { icon: 'push', text: '想推開東西' },
  ],
  scared: [
    { icon: 'shiver', text: '身體發抖' },
    { icon: 'door', text: '想躲起來' },
    { icon: 'handshake', text: '抓緊大人的手' },
    { icon: 'heartbeat', text: '心跳變好快' },
  ],
  surprised: [
    { icon: 'eye', text: '眼睛睜得好大' },
    { icon: 'gasp', text: '嘴巴張成圓形' },
    { icon: 'speech', text: '「哇」地叫出來' },
    { icon: 'pause', text: '整個人停住' },
  ],
  calm: [
    { icon: 'bubble', text: '慢慢地呼吸' },
    { icon: 'chair', text: '坐得住' },
    { icon: 'journal', text: '可以專心做事' },
    { icon: 'sofa', text: '身體鬆鬆的' },
  ],
  shy: [
    { icon: 'blossom', text: '臉紅紅的' },
    { icon: 'quiet', text: '聲音變小' },
    { icon: 'shirt', text: '摸摸自己的衣角' },
    { icon: 'again', text: '把身體轉開' },
  ],
  tired: [
    { icon: 'zzz', text: '一直打呵欠' },
    { icon: 'moon', text: '眼皮變好重' },
    { icon: 'bed', text: '想躺下來' },
    { icon: 'turtle', text: '走路變慢' },
  ],
}
